...
RSpec.describe FollowersNumber::Validator do
  describe '.validate!' do
    ...
    it 'returns true when facebook URL is given' do
      expect(
        described_class.validate!('https://facebook.com/profile')
      ).to eq(true)
    end

    it 'returns true when medium URL is given' do
      expect(
        described_class.validate!('https://medium.com/profile')
      ).to eq(true)
    end
